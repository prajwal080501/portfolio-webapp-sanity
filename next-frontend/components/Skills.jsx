    ...
    <div>
          <div className="container py-16 md:py-20" id="services">
            ...
            <div className="grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
              <div className="group rounded-xl px-8 py-12 shadow-lg hover:bg-primary duration-200  cursor-pointer ease-linear">
              ...
              <div className="group rounded-xl px-8 py-12 shadow hover:bg-primary duration-200 cursor-pointer ease-linear">
                <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                  <div className="hidden group-hover:block">
                    <img
